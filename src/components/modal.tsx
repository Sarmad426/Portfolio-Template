...
import { projectObj } from "@/data/profile-data";
  ...
  return (
    ...
    >
      <div className="px-6 py-8 relative">
        ...
        <p className="my-4 text-base text-gray-600 dark:text-darkSecondaryColor">
          {description}
        </p>
          ...
          <ul className="my-3">
            ...
            {pages.map((page) => {
              return (
                <li
                  key={page}
                  className="text-xs font-light text-gray-600 dark:text-darkSecondaryColor list-decimal font-[sans-serif]"
                >
                  {page}
                </li>
              );
          ...
          <ul className="my-3">
            ...
            {features.map((feature) => {
              return (
                <li
                  key={feature}
                  className="text-sm font-light text-gray-700 dark:text-darkSecondaryColor font-[calibri]"
                >
                  {feature}
                </li>
              );
